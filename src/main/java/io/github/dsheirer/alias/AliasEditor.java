...
public class AliasEditor extends Editor<Alias> implements ActionListener, Listener<AliasEvent>
{
    ...
    public AliasEditor(PlaylistManager playlistManager, IconManager iconManager)
    {
        mAliasModel = playlistManager.getAliasModel();
        mAliasNameEditor = new AliasNameEditor(mAliasModel, iconManager);
        mAliasIdentifierEditor = new AliasIdentifierEditor(playlistManager);
        mAliasActionEditor = new AliasActionEditor(playlistManager.getAliasModel());
